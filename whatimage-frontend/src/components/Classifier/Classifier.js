                    ...
                    <section className="container">
                        ...
                        {this.state.resentImage &&(
                            <React.Fragment>
                                {
                                <Alert variant='info'>
                                    <a  href={`https://www.google.com/search?q=About ${this.state.resentImage.data.classified}`}><b>{this.state.resentImage.data.classified}</b> kassaligi haqida ma'lumotlar</a>
                                </Alert> }
